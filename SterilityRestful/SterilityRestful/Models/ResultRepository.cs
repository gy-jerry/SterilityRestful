...
namespace SterilityRestful.Models
{
    public class ResultRepository : IResultRepository
    {
        ...
        {
            return ResultMethod.ResIncubatorSetData(pclsCache, TestId, TubeNo, CultureId, BacterId, OtherRea, IncubatorId, Place, StartTime, EndTime, AnalResult);
        }
        ...
        {
            return ResultMethod.ResIncubatorGetResultTubesByAnyProperty(pclsCache, TestId, TubeNo, CultureId, BacterId, OtherRea, IncubatorId, Place, StartTimeS, StartTimeE, EndTimeS, EndTimeE, AnalResult, GetCultureId, GetBacterId, GetOtherRea, GetIncubatorId, GetPlace, GetStartTime, GetEndTime, GetAnalResult);
        }
