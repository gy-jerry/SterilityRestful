...
namespace SterilityRestful.Models
{
    public interface IResultRepository
    {
        ...
        int ResIncubatorSetData(DataConnection pclsCache, string TestId, string TubeNo, string CultureId, string BacterId, string OtherRea, string IncubatorId, string Place, string StartTime, string EndTime, string AnalResult);
