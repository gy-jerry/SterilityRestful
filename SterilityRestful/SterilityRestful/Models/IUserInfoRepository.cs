...
namespace SterilityRestful.Models
{
    public interface IUserInfoRepository
    {
        ...
        GetUserInfo MstUserGetUserInfo(DataConnection pclsCache, string UserId, int Identify, int PhoneNo, int UserName, int Role, int Password, int LastLoginTime, int RevisionInfo);
